import type { GameAction, GameState, SeatConfig, Card, PokerAction } from '../games/tripoley/types';
import type { HouseRules } from '../games/tripoley/houseRules';
import { POT_SECTION_KEYS } from '../games/tripoley/constants';
import { gameReducer, initialGameState } from '../games/tripoley/reducer';
import { getAIAction } from '../games/tripoley/ai';
import { getLegalMichiganPlays, canPassLead } from '../games/tripoley/michigan';
import { michiganRecoveryActions } from '../games/tripoley/michiganRecovery';
import { createEmptyPot } from '../games/tripoley/payCards';
import { applyAnteToPot, distributePlayerAnte } from '../games/tripoley/antes';
import { inGamePlayers } from '../games/tripoley/playerStatus';
